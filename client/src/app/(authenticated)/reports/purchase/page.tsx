    ...
    <TsnGrid
      ...
      onFilterPanel={() => {
        ...
        return (<div className='flex flex-col gap-1'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-2'>
            <TsnInput type='date' title='Başlangıç Tarihi' defaultValue={filter.startDate} onChange={e => setFilter({ ...filter, startDate: e.target.value })} />
            <TsnInput type='date' title='Bitiş Tarihi' defaultValue={filter.endDate} onChange={e => setFilter({ ...filter, endDate: e.target.value })} />
          </div>
      ...
      onHeaderPaint={() => <>
        <div className='grid grid-cols-8 w-full'>
          <div className='col-span-2 flex flex-row gap-1'>Ürün</div>
          <div className='col-span-2 flex flex-row gap-1'>Firma</div>
          <div className='text-end'>Alış</div>
          <div className='text-end'>Alış Toplam</div>
          <div className='text-end'>Satış</div>
          <div className='text-end'>Satış Toplam</div>
        </div>
      </>}
