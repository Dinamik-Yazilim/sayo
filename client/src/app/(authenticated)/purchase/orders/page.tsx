    ...
    <TsnGrid
      ...
      onFilterPanel={() => {
        return (<div className='flex flex-col gap-1'>
          ...
          <TsnSelect title="Kapalı mı?" all list={[{ _id: '0', name: 'Açık' }, { _id: '1', name: 'Kapalı' }]} value={filter.isClosed} onValueChange={e => setFilter({ ...filter, isClosed: e })} />
        </div>)
      }}
      onHeaderPaint={() => <>
        <div className='grid grid-cols-9 w-full'>
          ...
          <div className='text-end'>Tutar/İndirimler</div>
      ...
      onRowPaint={(e: OrderHeader, colIndex) => <div className='grid grid-cols-9 w-full items-center'>
        ...
        <div className='col-span-3 flex flex-col gap-1 items-start'>
          ...
          <div className=''>Satır Sayısı: <span className='text-foreground'>{e.lineCount}</span></div>
