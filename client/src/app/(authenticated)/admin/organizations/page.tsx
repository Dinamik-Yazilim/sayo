  ...
  const connectOrg = (orgId?: string) => {
    postItem(`/admin/organizations/connect/${orgId}`, token)
      .then((org: Organization) => {
        ...
        toast({ title: 'Organizasyon bağlandı', description: org.name?.toUpperCase(), duration: 1000 })
  ...
  return (
    <ListGrid
      ...
      onHeaderPaint={() => <div className='grid  grid-cols-5 w-full'>
        <div className='col-span-4 lg:col-span-1'>Ad</div>
        <div className='hidden lg:flex'>Konum</div>
