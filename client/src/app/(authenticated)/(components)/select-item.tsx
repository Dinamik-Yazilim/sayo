    ...
    <AlertDialog onOpenChange={e => e && load(search)} >
      ...
      <AlertDialogContent className=" px-3 py-1 lg:max-w-[900px]">
        ...
        <div className="overflow-y-auto h-[600px]">
          ...
          <TsnPanel name="itemSelect_filter" trigger={<>Grup/Kategori/Marka/Reyon </>} defaultOpen={false} className="pe-4">
          ...
          <div className='grid grid-cols-6 w-full text-xs lg:text-sm border-b mb-2 ps-2 pe-5'>
            <div className='col-span-3 flex flex-row gap-1'>Ürün</div>
            <div className='col-span-2 flex flex-row gap-1'>Grup</div>
