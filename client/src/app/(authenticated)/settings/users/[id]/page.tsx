...
export default function UserEditPage({ params }: Props) {
  ...
  >
    ...
    <TsnPanel name="changePass" className="mt-4" trigger='Şifreyi Değiştir' contentClassName="grid grid-cols-2 gap-2 w-full">
      <TsnInput type='password' title='Şifre' onChange={e => setPassword(e.target.value)} />
      <TsnInput type='password' title='Şifre Tekrar' onChange={e => setPassword(e.target.value)} />
    </TsnPanel>
  </StandartForm>)
}
