module.exports = (req) =>
	new Promise(async (resolve, reject) => {
		try {
			if (!req.params.param1) return reject(`Parametre gerekli`)
			...
			if (req.params.param1 == 'username') {
				...
				return reject(`Geçersiz parametre. Kullanım: /auth/check/username/:[email | phoneNumber] | /auth/check/organization/:organizationName`)
			}
